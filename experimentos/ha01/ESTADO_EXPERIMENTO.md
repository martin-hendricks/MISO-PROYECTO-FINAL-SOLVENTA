...
_Actualizado automáticamente: 2026-09-16 22:38:05. Se regenera al cerrar cada corrida y se sube al repositorio con su evidencia._
...
| Progreso | **56 de 56** corridas ejecutadas · 56 válidas |
| En curso | — |
| Pendientes | 0 · fin estimado hacia las — |
| Válidas / sospechosas / inválidas / fallidas | 51 / 0 / 0 / 0 |
...
| 50 | `cache_opportunistic_b3_estampida_ttl2b` | C | sin_respuesta | 1.0 | 200 | ✅ válida | 64,5 | 183,2 | 0,00 % | 99,64 % | 4,1 | 11/09 20:22 |
| 51 | `cache_singleflight_b3_estampida_ttl2b` | C' | sin_respuesta | 1.0 | 200 | ✅ válida | 64,7 | 184,5 | 0,00 % | 98,74 % | 3,8 | 11/09 20:29 |
...
| 46 | `cache_blocking_b4b_sano` | B | sano | 0.96 | 20→200 | ✅ válida | 64,8 | 139,2 | 0,00 % | 0,00 % | 4,1 | 11/09 19:46 |
| 47 | `cache_opportunistic_b4b_sano` | C | sano | 0.96 | 20→200 | ✅ válida | 64,8 | 138,1 | 0,00 % | 0,13 % | 4,3 | 11/09 19:56 |
...
| 53 | `cache_blocking_b5b_intermitente_count` | B | intermitente | 0.96 | 200.0 | ✅ válida | 64,9 | 719,8 | 1,25 % | 1,25 % | 4,3 | 16/09 22:30 |
| 54 | `cache_blocking_b5b_intermitente_rate` | B | intermitente | 0.96 | 200.0 | ✅ válida | 64,8 | 717,9 | 1,22 % | 1,23 % | 4,1 | 16/09 22:16 |
| 55 | `cache_opportunistic_b5b_intermitente_count` | C | intermitente | 0.96 | 200.0 | ✅ válida | 64,9 | 178,3 | 0,00 % | 1,26 % | 3,8 | 16/09 22:38 |
| 56 | `cache_opportunistic_b5b_intermitente_rate` | C | intermitente | 0.96 | 200.0 | ✅ válida | 64,8 | 178,0 | 0,00 % | 1,23 % | 4,3 | 16/09 22:23 |
